...
public class DatabaseConnectionPool {
    ...
    private int incrementalConnections = 3;// 连接池自动增加的大小
...
// 它中存放的对象为 PooledConnection 型
     ...
     * 构造函数
     *
     *   jdbcDriver String JDBC 驱动类串
     *   dbUrl String 数据库 URL
     *   dbUsername String 连接数据库用户名
     *   dbPassword String 连接数据库用户的密码
     *
     */
    public DatabaseConnectionPool(String jdbcDriver,String dbUrl,String dbUsername,String dbPassword) {
